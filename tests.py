...
class SeleniumTest(MyHTTPTestCase):
    def setUp(self):
        ...
        driver_name = os.environ['TAGUETTE_TEST_WEBDRIVER'].lower()
        if driver_name == 'chromium':
...
class TestSeleniumMultiuser(SeleniumTest):
    ...
    async def test_login(self):
        ...
        await self.s_click(accept_button)
        ...
        await self.s_click(register_button)
        ...
        await self.s_click(login_button)
        self.assertEqual(self.s_path, '/project/1')
